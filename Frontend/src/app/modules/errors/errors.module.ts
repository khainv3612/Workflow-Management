...
import {Error_denyComponent} from "./permission-denied/error_deny.component";


@NgModule({
  declarations: [Error_denyComponent, ErrorsComponent, Error1Component, Error2Component, Error3Component, Error4Component, Error5Component, Error6Component ],
  imports: [
    CommonModule,
    ErrorsRoutingModule
  ]
